...
The new source-scoped preprocessing run `0892ebfc-8b33-4051-95da-4a239b288e40` completed over all 24,446 passages: 25,959 chunks, 24,194 eligible, 1,761 excluded for explicit quality flags, and 4 exact duplicate chunks. Every film has at least four eligible chunks. No embedding run has been started from this new source version yet; model evaluation and retrieval benchmarking remain the next gate. Wikidata's 906 unavailable original snapshots and their explicitly linked assertion impact remain unresolved and must not be silently folded into this narrative index.
